...
if __name__ == '__main__':
    ...
    menu_configuration = [
        (f"{appname} configuration", "more /etc/syslog-ng/syslog-ng.conf"),
        (f"{appname} default configuration", "more /etc/default/syslog-ng"),
        (f"{appname} logrotate configuration", "more /etc/logrotate.d/syslog-ng"),
    ...
    menu_debug = [
        ("Send test syslog message", f"{debugdir}/send_test_syslog_msg.sh"),
